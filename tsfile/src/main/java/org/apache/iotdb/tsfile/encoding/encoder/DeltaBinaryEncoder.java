...
public abstract class DeltaBinaryEncoder extends Encoder {
  ...
  // set BLOCK_DEFAULT_SIZE larger than chunk_point_size used in experiments to fullfill the assumption that chunk=page=pack
  // note that BLOCK_DEFAULT_SIZE cannot be set too large because it decides the space used to encode data.
  public static final int BLOCK_DEFAULT_SIZE = 10000;
