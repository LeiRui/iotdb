...
public class IoTDBConfig {
  ...
  private boolean enableM4LSM = false;
  ...
  /**
   * How many threads can concurrently read data for raw data query. When <= 0, use CPU core
   * number.
   */
  ...
  public boolean isEnableM4LSM() {
    return enableM4LSM;
  }

  public void setEnableM4LSM(boolean enableM4LSM) {
    this.enableM4LSM = enableM4LSM;
  }
